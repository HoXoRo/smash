...
public static class UtilityBuiltin
{
    ...
    public static class AssetsPath
    {
        ...
        {
            return Utility.Text.Format("Assets/ArrowGame/DataTable/{0}.{1}", name, useBytes ? "bytes": "txt");
        }

        public static string GetSoundPath(string name)
        {
            return Utility.Text.Format("Assets/ArrowGame/Audio/{0}", name);
        }

        public static string GetScenePath(string name)
        {
            return Utility.Text.Format("Assets/ArrowGame/Scene/{0}.unity", name);
        }
        public static string GetEntityPath(string name)
        {
            return Utility.Text.Format("Assets/ArrowGame/Prefabs/Entity/{0}.prefab", name);
        }

        public static string GetUIFormPath(string v)
        {
            return Utility.Text.Format("Assets/ArrowGame/Prefabs/UI/{0}.prefab", v);
        }

        public static string GetTexturePath(string fileName)
        {
            return Utility.Text.Format("Assets/ArrowGame/Textures/{0}", fileName);
        }
        public static string GetSpritesPath(string fileName)
        {
            return Utility.Text.Format("Assets/ArrowGame/Sprites/{0}", fileName);
        }
        public static string GetConfigPath(string v, bool useBytes)
        {
            return Utility.Text.Format("Assets/ArrowGame/Config/{0}.{1}", v, useBytes ? "bytes" : "txt");
        }
        ...
        {
            return Utility.Text.Format("Assets/ArrowGame/Prefabs/{0}.prefab", v);
        }

        public static string GetLanguagePath(string v, bool useBytes)
        {
            return Utility.Text.Format("Assets/ArrowGame/Language/{0}.{1}", v, useBytes ? "bytes" : "json");
        }
        public static string GetMaterialPath(string v)
        {
            return Utility.Text.Format("Assets/ArrowGame/Material/{0}.mat", v);
        }

        public static string GetHotfixDll(string dllName)
        {
            return Utility.Text.Format("Assets/ArrowGame/HotfixDlls/{0}.bytes", dllName);
        }
