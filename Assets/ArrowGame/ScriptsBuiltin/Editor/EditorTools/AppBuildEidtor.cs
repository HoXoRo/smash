    ...
    public class AppBuildEidtor : EditorWindow
    {
        ...
        private void DrawAppBuildSettingsPanel()
        {
            ...
            EditorGUILayout.BeginHorizontal();
            {
                ...
                // EditorUserBuildSettings.exportAsGoogleAndroidProject = EditorGUILayout.ToggleLeft("Export Android Project", EditorUserBuildSettings.exportAsGoogleAndroidProject);
        ...
        public void JenkinsBuildApp(JenkinsBuildAppConfig configJson)
        {
            ...
            // EditorUserBuildSettings.exportAsGoogleAndroidProject = configJson.ExportAndroidProject;
