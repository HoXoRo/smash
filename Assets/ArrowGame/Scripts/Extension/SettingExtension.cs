...
public static class SettingExtension
{
    ...
    /// <param name="com"></param>
    /// <returns></returns>
    public static bool GetPrivacyPolicyAgree(this SettingComponent com)
    {
        string key = "PrivacyPolicyAgree";
        return com.GetBool(key, true);
    }
    /// <summary>
    /// 设置隐私政策是否同意
    /// </summary>
    ...
    public static void SetPrivacyPolicyAgree(this SettingComponent com, bool isAgree)
    {
        string key = "PrivacyPolicyAgree";
        com.SetBool(key, isAgree);
    }
}