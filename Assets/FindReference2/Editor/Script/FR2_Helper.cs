...
namespace vietlabs.fr2
{
	public class FR2_Helper
	{
		...
		public static IEnumerable<GameObject> getAllObjsInCurScene()
		{
			...
			{
                UnityEngine.SceneManagement.Scene scene = UnityEngine.SceneManagement.SceneManager.GetSceneAt(j);
		...
		private static IEnumerable<GameObject> GetGameObjectsInScene(UnityEngine.SceneManagement.Scene scene)
		{
